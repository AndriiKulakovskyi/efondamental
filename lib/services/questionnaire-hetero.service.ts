...
export async function getAutresPathoResponse(
  visitId: string
...
export async function saveAutresPathoResponse(
  response: AutresPathoResponseInsert
): Promise<AutresPathoResponse> {
  const supabase = await createClient();
...
export async function saveWais3DigitSpanResponse(
  ...
  const { data, error } = await supabase
    ...
    .upsert({
      ...
      wais3_mcod_1: response.mcod_1a + response.mcod_1b,
      wais3_mcod_2: response.mcod_2a + response.mcod_2b,
      wais3_mcod_3: response.mcod_3a + response.mcod_3b,
      wais3_mcod_4: response.mcod_4a + response.mcod_4b,
      wais3_mcod_5: response.mcod_5a + response.mcod_5b,
      wais3_mcod_6: response.mcod_6a + response.mcod_6b,
      wais3_mcod_7: response.mcod_7a + response.mcod_7b,
      wais3_mcod_8: response.mcod_8a + response.mcod_8b,
      // Individual item scores (Ordre Inverse)
      wais3_mcoi_1: response.mcoi_1a + response.mcoi_1b,
      wais3_mcoi_2: response.mcoi_2a + response.mcoi_2b,
      wais3_mcoi_3: response.mcoi_3a + response.mcoi_3b,
      wais3_mcoi_4: response.mcoi_4a + response.mcoi_4b,
      wais3_mcoi_5: response.mcoi_5a + response.mcoi_5b,
      wais3_mcoi_6: response.mcoi_6a + response.mcoi_6b,
      wais3_mcoi_7: response.mcoi_7a + response.mcoi_7b,
      // Section and global scores
      wais_mcod_tot: scores.wais_mcod_tot,
      wais_mcoi_tot: scores.wais_mcoi_tot,
      wais_mc_tot: scores.wais_mc_tot,
      wais_mc_end: scores.wais_mc_end,
