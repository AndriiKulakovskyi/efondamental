...
// Note: C-SSRS has been moved to @/lib/questionnaires/bipolar/initial/medical/cssrs.ts
...
export const MEM3_SPATIAL_QUESTIONS: Question[] = [
  ...
  { id: 'odirect_1a', text: 'ITEM 1 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_1b', text: 'ITEM 1 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_1_note', text: 'Note a l\'item 1', type: 'number', required: false, section: 'Ordre Direct (Forward)', readonly: true },
  { id: 'odirect_2a', text: 'ITEM 2 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_2b', text: 'ITEM 2 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_2_note', text: 'Note a l\'item 2', type: 'number', required: false, section: 'Ordre Direct (Forward)', readonly: true },
  { id: 'odirect_3a', text: 'ITEM 3 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_3b', text: 'ITEM 3 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_3_note', text: 'Note a l\'item 3', type: 'number', required: false, section: 'Ordre Direct (Forward)', readonly: true },
  { id: 'odirect_4a', text: 'ITEM 4 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_4b', text: 'ITEM 4 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_4_note', text: 'Note a l\'item 4', type: 'number', required: false, section: 'Ordre Direct (Forward)', readonly: true },
  { id: 'odirect_5a', text: 'ITEM 5 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_5b', text: 'ITEM 5 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_5_note', text: 'Note a l\'item 5', type: 'number', required: false, section: 'Ordre Direct (Forward)', readonly: true },
  { id: 'odirect_6a', text: 'ITEM 6 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_6b', text: 'ITEM 6 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_6_note', text: 'Note a l\'item 6', type: 'number', required: false, section: 'Ordre Direct (Forward)', readonly: true },
  { id: 'odirect_7a', text: 'ITEM 7 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_7b', text: 'ITEM 7 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_7_note', text: 'Note a l\'item 7', type: 'number', required: false, section: 'Ordre Direct (Forward)', readonly: true },
  { id: 'odirect_8a', text: 'ITEM 8 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_8b', text: 'ITEM 8 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Ordre Direct (Forward)', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'odirect_8_note', text: 'Note a l\'item 8', type: 'number', required: false, section: 'Ordre Direct (Forward)', readonly: true },
  
  // Backward (Ordre Inverse) items
  {
    id: 'section_inverse',
    text: 'Score ordre inverse',
    type: 'section',
    required: false
  },
  { id: 'inverse_1a', text: 'ITEM 1 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_1b', text: 'ITEM 1 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_1_note', text: 'Note a l\'item 1', type: 'number', required: false, section: 'Score ordre inverse', readonly: true },
  { id: 'inverse_2a', text: 'ITEM 2 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_2b', text: 'ITEM 2 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_2_note', text: 'Note a l\'item 2', type: 'number', required: false, section: 'Score ordre inverse', readonly: true },
  { id: 'inverse_3a', text: 'ITEM 3 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_3b', text: 'ITEM 3 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_3_note', text: 'Note a l\'item 3', type: 'number', required: false, section: 'Score ordre inverse', readonly: true },
  { id: 'inverse_4a', text: 'ITEM 4 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_4b', text: 'ITEM 4 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_4_note', text: 'Note a l\'item 4', type: 'number', required: false, section: 'Score ordre inverse', readonly: true },
  { id: 'inverse_5a', text: 'ITEM 5 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_5b', text: 'ITEM 5 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_5_note', text: 'Note a l\'item 5', type: 'number', required: false, section: 'Score ordre inverse', readonly: true },
  { id: 'inverse_6a', text: 'ITEM 6 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_6b', text: 'ITEM 6 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_6_note', text: 'Note a l\'item 6', type: 'number', required: false, section: 'Score ordre inverse', readonly: true },
  { id: 'inverse_7a', text: 'ITEM 7 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_7b', text: 'ITEM 7 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_7_note', text: 'Note a l\'item 7', type: 'number', required: false, section: 'Score ordre inverse', readonly: true },
  { id: 'inverse_8a', text: 'ITEM 8 - Note a l\'essai 1', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_8b', text: 'ITEM 8 - Note a l\'essai 2', type: 'single_choice', required: true, section: 'Score ordre inverse', options: MEM3_SPATIAL_SCORE_OPTIONS },
  { id: 'inverse_8_note', text: 'Note a l\'item 8', type: 'number', required: false, section: 'Score ordre inverse', readonly: true },

  // Summary Sections (at the end)
  {
    id: 'section_summary_odirect',
    text: 'Score ordre direct',
    type: 'section',
    required: false
  },
  { id: 'mspatiale_odirect_tot', text: 'Total Ordre direct', type: 'number', required: false, section: 'Score ordre direct', readonly: true, help: 'Somme des scores Ordre Direct (calculé automatiquement)' },
  { id: 'mspatiale_odirect_std', text: 'Total Ordre direct note standard', type: 'number', required: false, section: 'Score ordre direct', readonly: true, help: 'Score standard selon l\'age' },
  { id: 'mspatiale_odirect_cr', text: 'Déviation par rapport à la moyenne et l’écart type. Ordre direct', type: 'number', required: false, section: 'Score ordre direct', readonly: true, help: '(Note standard - 10) / 3' },

  {
    id: 'section_summary_inverse',
    text: 'Score ordre inverse',
    type: 'section',
    required: false
  },
  { id: 'mspatiale_inverse_tot', text: 'Total Ordre inverse', type: 'number', required: false, section: 'Score ordre inverse', readonly: true, help: 'Somme des scores Ordre Inverse (calculé automatiquement)' },
  { id: 'mspatiale_inverse_std', text: 'Total Ordre inverse note standard', type: 'number', required: false, section: 'Score ordre inverse', readonly: true, help: 'Score standard selon l\'age' },
  { id: 'mspatiale_inverse_cr', text: 'Déviation par rapport à la moyenne et l’écart type. Ordre inverse', type: 'number', required: false, section: 'Score ordre inverse', readonly: true, help: '(Note standard - 10) / 3' },

  {
    id: 'section_summary_total',
    text: 'Score total',
    type: 'section',
    required: false
  },
  { id: 'mspatiale_total_brut', text: 'Note totale brute', type: 'number', required: false, section: 'Score total', readonly: true, help: 'Ordre Direct + Ordre Inverse' },
  { id: 'mspatiale_total_std', text: 'Note totale standard', type: 'number', required: false, section: 'Score total', readonly: true, help: 'Score standard selon l\'age' },
  { id: 'mspatiale_total_cr', text: 'Déviation par rapport à la moyenne et l’écart type. Total', type: 'number', required: false, section: 'Score total', readonly: true, help: '(Note standard - 10) / 3' }
];
