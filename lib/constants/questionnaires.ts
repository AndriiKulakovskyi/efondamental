...
export const QIDS_QUESTIONS: Question[] = [
  { id: "q1", text: "1. Endormissement", type: "single_choice", required: true, options: [
  ...
  { id: "q2", text: "2. Sommeil pendant la nuit", type: "single_choice", required: true, options: [
  ...
  { id: "q3", text: "3. Réveil avant l'heure prévue", type: "single_choice", required: true, options: [
  ...
  { id: "q4", text: "4. Sommeil excessif", type: "single_choice", required: true, options: [
  ...
  { id: "q5", text: "5. Tristesse", type: "single_choice", required: true, options: [
  ...
  { id: "q6", text: "6. Diminution de l'appétit", type: "single_choice", required: true, options: [
  ...
  { id: "q7", text: "7. Augmentation de l'appétit", type: "single_choice", required: true, options: [
    { code: 0, label: "J'ai le même appétit que d'habitude.", score: 0 },
  ...
  { id: "q8", text: "8. Perte de poids (au cours des 15 derniers jours)", type: "single_choice", required: true, options: [
  ...
  { id: "q9", text: "9. Prise de poids (au cours des 15 derniers jours)", type: "single_choice", required: true, options: [
    { code: 0, label: "Mon poids n'a pas changé.", score: 0 },
  ...
  { id: "q10", text: "10. Concentration/Prise de décisions", type: "single_choice", required: true, options: [
  ...
  { id: "q11", text: "11. Opinion de moi-même", type: "single_choice", required: true, options: [
  ...
  { id: "q12", text: "12. Idées de mort ou de suicide", type: "single_choice", required: true, help: "En cas d'idéation suicidaire, alerter immédiatement le clinicien.", options: [
  ...
  { id: "q13", text: "13. Enthousiasme général", type: "single_choice", required: true, options: [
  ...
  { id: "q14", text: "14. Énergie", type: "single_choice", required: true, options: [
  ...
  { id: "q15", text: "15. Impression de ralentissement", type: "single_choice", required: true, options: [
  ...
  { id: "q16", text: "16. Impression d'agitation", type: "single_choice", required: true, options: [
...
export const AQ12_QUESTIONS: Question[] = [
  { id: 'q1', text: '1. Si on me provoque, je peux cogner.', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q2', text: "2. J'exprime souvent mon désaccord avec les autres.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q3', text: "3. Je m'emporte rapidement.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q4', text: "4. Parfois, j'ai l'impression que je n'ai pas été gâté par la vie comme les autres.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q5', text: "5. Il y a des personnes qui me gonflent tellement qu'on peut en arriver aux mains.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q6', text: "6. Je ne peux pas m'empêcher d'entrer en conflit quand les autres ne sont pas d'accord avec moi.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q7', text: '7. Parfois, je pète un câble sans raison.', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q8', text: "8. Je me demande parfois pourquoi je ressens tant d'amertume.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q9', text: "9. J'ai déjà menacé quelqu'un.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q10', text: "10. Mes amis disent que j'ai l'esprit de contradiction.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q11', text: "11. J'ai du mal à contrôler mon humeur.", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] },
  { id: 'q12', text: '12. Les autres semblent toujours avoir plus de chances que moi.', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Pas du tout moi' }, { code: 2, label: '2' }, { code: 3, label: '3' }, { code: 4, label: '4' }, { code: 5, label: '5' }, { code: 6, label: '6 – Tout à fait moi' }] }
];
...
export const CTI_QUESTIONS: Question[] = [
  { id: 'q1', text: '1. Avez-vous tendance à avoir besoin de plus de sommeil que les autres personnes ?', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q2', text: "2. Si vous aviez à faire un certain travail au milieu de la nuit, pensez-vous que vous pourriez le faire presque aussi facilement qu'à une heure plus normale de la journée ?", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q3', text: "3. Est-ce que vous trouvez qu'il est difficile de vous réveiller correctement si vous êtes réveillé à une heure inhabituelle ?", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q4', text: '4. Aimez-vous travailler à des heures inhabituelles du jour ou de la nuit ?', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q5', text: '5. Si vous allez au lit très tard, avez-vous besoin de dormir plus tard le lendemain matin ?', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q6', text: "6. Si vous avez beaucoup à faire, pouvez-vous travailler tard le soir pour terminer sans être trop fatigué ?", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q7', text: '7. Vous sentez-vous endormi pendant un certain temps après le réveil le matin ?', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q8', text: '8. Trouvez-vous aussi facile de travailler tard la nuit que tôt le matin ?', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q9', text: '9. Si vous devez vous lever très tôt un matin, avez-vous tendance à vous sentir fatigué toute la journée ?', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q10', text: '10. Seriez-vous aussi content de faire quelque chose au milieu de la nuit que pendant la journée ?', type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] },
  { id: 'q11', text: "11. Devez-vous compter sur un réveil, ou sur quelqu'un d'autre, pour vous réveiller le matin ?", type: 'single_choice', required: true, options: [{ code: 1, label: '1 – Presque jamais' }, { code: 2, label: '2 – Rarement' }, { code: 3, label: '3 – Parfois' }, { code: 4, label: '4 – En général' }, { code: 5, label: '5 – Presque toujours' }] }
];
...
export const CTI_DEFINITION: QuestionnaireDefinition = {
  ...
  metadata: {
    pathologies: ['bipolar'],
    target_role: 'patient',
    instructions: "Les questions suivantes concernent vos habitudes quotidiennes et vos préférences. Merci d'indiquer ce que vous préférez faire ou pouvez faire mais pas ce que vous êtes forcés de faire en raison d'engagements professionnels. Merci de répondre aux questions le plus rapidement possible (entourez une seule réponse par question).",
    subscales: {
      flexibility: [2, 4, 6, 8, 10],
      languid: [1, 3, 5, 7, 9, 11]
    },
    score_ranges: {
      flexibility: { min: 5, max: 25 },
      languid: { min: 6, max: 30 },
      total: { min: 11, max: 55 }
    }
  }
};
