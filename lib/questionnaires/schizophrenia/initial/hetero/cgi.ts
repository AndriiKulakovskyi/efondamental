...
export interface SchizophreniaCgiResponse {
  id: string;
  visit_id: string;
  patient_id: string;
  cgi_s: number | null;
...
export type SchizophreniaCgiResponseInsert = Omit<
  SchizophreniaCgiResponse,
  'id' | 'created_at' | 'updated_at' | 'completed_at' | 'interpretation' | 'therapeutic_index' | 'therapeutic_index_label'
> & {
  completed_by?: string | null;
};
...
export const CGI_SZ_DEFINITION: QuestionnaireDefinition = {
  id: 'cgi_sz',
  code: 'CGI_SZ',
