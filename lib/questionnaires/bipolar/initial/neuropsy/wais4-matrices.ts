// eFondaMental Platform - WAIS-IV Matrices
...
export interface BipolarWais4MatricesResponse {
  id: string;
  visit_id: string;
  patient_id: string;
...
export const WAIS4_MATRICES_QUESTIONS: Question[] = [
  {
    id: 'section_instructions',
    text: 'WAIS-IV Matrices',
...
export function computeWais4MatricesRawScore(responses: Record<string, number>): number {
  let total = 0;
  for (let i = 1; i <= 26; i++) {
...
export const WAIS4_MATRICES_DEFINITION: QuestionnaireDefinition = {
  id: 'wais4_matrices',
  code: 'WAIS4_MATRICES',
  title: 'WAIS-IV Matrices',
  description: 'Sous-test Matrices de la WAIS-IV - Evaluation du raisonnement perceptif et de l\'intelligence fluide.',
