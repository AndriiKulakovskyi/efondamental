// eFondaMental Platform - WAIS-III Learning Disorders
// Bipolar Initial Evaluation - Neuropsy Module
// Note: Uses same questions as WAIS-IV Learning
...
export interface BipolarWais3LearningResponse {
  id: string;
  visit_id: string;
  patient_id: string;
  // Learning Disorders
...
export type BipolarWais3LearningResponseInsert = Omit<
  BipolarWais3LearningResponse,
...
// ============================================================================
// Questions Dictionary (same as WAIS-IV Learning)
// ============================================================================
...
export const WAIS3_LEARNING_QUESTIONS: Question[] = [
  {
    id: 'dyslexia',
...
export const WAIS3_LEARNING_DEFINITION: QuestionnaireDefinition = {
  ...
  questions: WAIS3_LEARNING_QUESTIONS,
  metadata: {
    singleColumn: true,
    pathologies: ['bipolar'],
