// eFondaMental Platform - WAIS-IV Clinical Criteria
...
export interface BipolarWais4CriteriaResponse {
  id: string;
  visit_id: string;
  patient_id: string;
  // General Information
...
export type BipolarWais4CriteriaResponseInsert = Omit<
  BipolarWais4CriteriaResponse,
...
export const WAIS4_CRITERIA_DEFINITION: QuestionnaireDefinition = {
  id: 'wais4_criteria',
  code: 'WAIS4_CRITERIA',
  title: 'WAIS-IV Criteres cliniques',
  description: 'Fiche de recueil des criteres cliniques et demographiques pour la passation de la WAIS-IV.',
