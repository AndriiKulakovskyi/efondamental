-- ============================================================================
-- eFondaMental Platform - Update Visit Detail RPC for Fluences Verbales
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- Fluences Verbales questionnaire (49 total questionnaires)
-- FIXED: Split jsonb_build_object to avoid 100 argument limit
-- ============================================================================

-- Drop existing function
DROP FUNCTION IF EXISTS get_visit_detail_data(UUID);

-- Recreate function with Fluences Verbales support
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    -- Initial evaluation visit with 49 questionnaires
    ...
    -- Neuropsychological Evaluation (9: WAIS-4 + CVLT + Code + Digit Span + TMT + Stroop + Fluences)
