-- ============================================================================
-- eFondaMental Platform - Update Visit Detail RPC for Test des Commissions
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- Test des Commissions questionnaire (53 total questionnaires)
...
-- Recreate function with Test des Commissions support
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    -- Initial evaluation visit with 53 questionnaires
    ...
    -- Neuropsychological Evaluation (13: 7 WAIS + TMT + Stroop + Fluences + COBRA + CPT3 + Commissions)
