-- Migration: Update get_visit_detail_data RPC to track BRIEF_A_AUTO_SZ completion
-- Purpose: Add new schizophrenia BRIEF-A Auto-Evaluation questionnaire to completion tracking
-- Date: 2026-02-03

-- Drop and recreate the function with updated auto-questionnaires tracking
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Schizophrenia auto module - UPDATED with BRIEF_A_AUTO_SZ
    v_statuses := v_statuses || jsonb_build_object(
...
COMMENT ON FUNCTION "public"."get_visit_detail_data"("p_visit_id" "uuid") IS 'Returns complete visit details including questionnaire completion status. Updated to include BRIEF_A_AUTO_SZ for schizophrenia initial evaluation autoquestionnaires module.';
