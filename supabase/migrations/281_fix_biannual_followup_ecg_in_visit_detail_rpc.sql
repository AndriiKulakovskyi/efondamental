-- ============================================================================
-- Fix Biannual Followup ECG Status in Visit Detail RPC
-- ============================================================================
-- The get_visit_detail_data RPC did not include the ECG questionnaire in the
-- biannual_followup status map. If the UI shows ECG in a biannual follow-up
-- visit, the missing key causes it to appear as not completed even after
-- validation.
--
-- This migration adds the ECG status entry for biannual_followup.
-- ============================================================================
...
DO $$
BEGIN
  RAISE NOTICE 'Added ECG status to biannual_followup in get_visit_detail_data RPC';
END $$;
