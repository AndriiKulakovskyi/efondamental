-- Remove TROUBLES_COMORBIDES_SZ from the annual_evaluation branch of get_visit_detail_data.
-- It should only be tracked in initial_evaluation visits.
...
COMMENT ON FUNCTION "public"."get_visit_detail_data"("p_visit_id" "uuid") IS 'Returns complete visit details including questionnaire completion status. TROUBLES_COMORBIDES_SZ is only tracked in initial_evaluation, not annual_evaluation.';
