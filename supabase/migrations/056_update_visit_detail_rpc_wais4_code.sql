-- ============================================================================
-- eFondaMental Platform - Update Visit Detail RPC for WAIS-IV Code
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- WAIS-IV Code questionnaire (45 total questionnaires)
-- ============================================================================

-- Drop existing function
DROP FUNCTION IF EXISTS get_visit_detail_data(UUID);

-- Recreate function with WAIS-IV Code support
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    -- Initial evaluation visit with 45 questionnaires (40 + 3 WAIS-4 + 1 CVLT + 1 WAIS-4 Code)
    WITH
    visit_data AS (
      SELECT *
      FROM v_visits_full
    ...
    questionnaire_statuses AS (
      SELECT jsonb_build_object(
        ...
        -- DSM5 / Medical Eval questionnaires (14: 9 DSM5 + 3 WAIS-4 + 1 CVLT + 1 WAIS-4 Code)
        ...
        -- Neuropsychological Evaluation (5: WAIS-4 Criteria + Learning + Matrices + CVLT + Code)
