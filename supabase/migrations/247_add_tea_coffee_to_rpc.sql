-- ============================================================================
-- Migration: Add TEA_COFFEE_SZ to Schizophrenia Initial Evaluation RPC
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the Tea and Coffee Consumption questionnaire completion tracking for 
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Chunk 6: SAS + PSP + ECV + TROUBLES_PSYCHOTIQUES + TROUBLES_COMORBIDES_SZ + TEA_COFFEE_SZ (6) - schizophrenia questionnaires
    v_statuses := v_statuses || jsonb_build_object(
...
DO $$
BEGIN
  RAISE NOTICE 'Updated get_visit_detail_data RPC to include TEA_COFFEE_SZ for schizophrenia initial evaluation';
END $$;
