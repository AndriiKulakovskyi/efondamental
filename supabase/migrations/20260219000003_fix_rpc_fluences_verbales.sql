-- ============================================================================
-- Fix: Restore correct get_visit_detail_data RPC function
-- The previous migration (000002) accidentally used wrong table names
-- (responses_asrm instead of bipolar_asrm, etc.)
-- This restores the correct function from the Stroop migration + adds FLUENCES_VERBALES_SZ
-- ============================================================================
...
COMMENT ON FUNCTION "public"."get_visit_detail_data"("p_visit_id" "uuid") IS 'Returns complete visit details including questionnaire completion status. Includes STROOP_SZ and FLUENCES_VERBALES_SZ for schizophrenia neuropsy module.';
