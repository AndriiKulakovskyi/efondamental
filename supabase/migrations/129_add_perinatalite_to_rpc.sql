-- ============================================================================
-- eFondaMental Platform - Add Périnatalité to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_perinatalite table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 68 if Fagerstrom required, 67 otherwise (includes ECG, SUICIDE_HISTORY, PERINATALITE)
        CASE WHEN v_fagerstrom_required THEN 68 ELSE 67 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (10) - includes SUICIDE_HISTORY and PERINATALITE
