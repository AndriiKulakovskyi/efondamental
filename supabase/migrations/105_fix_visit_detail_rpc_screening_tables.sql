-- ============================================================================
-- eFondaMental Platform - Fix RPC Screening Table References
-- ============================================================================
-- This migration fixes the get_visit_detail_data RPC function to use correct
-- table names for screening visits:
-- - responses_diagnostic -> responses_medical_diagnostic
-- - responses_orientation -> responses_bipolar_orientation
-- - DIAGNOSTIC_FR -> MEDICAL_DIAGNOSTIC_FR
-- - ORIENTATION_FR -> BIPOLAR_ORIENTATION_FR
-- ============================================================================
