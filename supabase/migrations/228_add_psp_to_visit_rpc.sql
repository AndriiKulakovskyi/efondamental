-- Update the get_visit_detail_data RPC function to include PSP completion status
-- This adds PSP tracking to the schizophrenia questionnaires chunk
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Chunk 6: SAS + PSP (2) - schizophrenia questionnaires
    v_statuses := v_statuses || jsonb_build_object(
