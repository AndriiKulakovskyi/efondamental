-- ============================================================================
-- eFondaMental Platform - Add Autres Pathologies to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_autres_patho table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 77 if Fagerstrom required, 76 otherwise (includes AUTRES_PATHO)
        CASE WHEN v_fagerstrom_required THEN 77 ELSE 76 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (19) - includes AUTRES_PATHO
