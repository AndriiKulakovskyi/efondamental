-- ============================================================================
-- eFondaMental Platform - Update Visit Detail RPC for SCIP
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- SCIP questionnaire (54 total questionnaires)
-- Split into groups to avoid 100 argument limit in jsonb_build_object
-- ============================================================================

-- Drop existing function
DROP FUNCTION IF EXISTS get_visit_detail_data(UUID);

-- Recreate function with SCIP support
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    -- Initial evaluation visit with 54 questionnaires
    -- Split into multiple jsonb objects to avoid 100 argument limit
    WITH
    visit_data AS (
      SELECT *
      FROM v_visits_full
    ...
    -- Neuropsychological Evaluation (14: 7 WAIS + TMT + Stroop + Fluences + COBRA + CPT3 + Commissions + SCIP)
