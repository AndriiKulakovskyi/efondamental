-- ============================================================================
-- eFondaMental Platform - Add Antécédents gynécologiques to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_antecedents_gyneco table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 74 if Fagerstrom required, 73 otherwise (includes ECG, SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO, PATHO_CARDIO, PATHO_ENDOC, PATHO_DERMATO, PATHO_URINAIRE, ANTECEDENTS_GYNECO)
        CASE WHEN v_fagerstrom_required THEN 74 ELSE 73 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (16) - includes SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO, PATHO_CARDIO, PATHO_ENDOC, PATHO_DERMATO, PATHO_URINAIRE, ANTECEDENTS_GYNECO
