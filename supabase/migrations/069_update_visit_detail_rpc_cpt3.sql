-- ============================================================================
-- eFondaMental Platform - Update Visit Detail RPC for CPT-III
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- CPT-III questionnaire (51 total questionnaires)
...
-- Recreate function with CPT-III support
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    -- Initial evaluation visit with 51 questionnaires
    ...
    -- Neuropsychological Evaluation (11: WAIS-4 + CVLT + Code + Digit Span + TMT + Stroop + Fluences + COBRA + CPT3)
