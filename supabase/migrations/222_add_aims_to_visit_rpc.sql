-- ============================================================================
-- Migration: Add AIMS questionnaire to get_visit_detail_data RPC
-- ============================================================================
-- Adds tracking for AIMS (Abnormal Involuntary Movement Scale) 
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Chunk 6: mod_auto_traits part 2 + schizophrenia questionnaires (11 items) - added AIMS
    v_statuses := v_statuses || jsonb_build_object(
