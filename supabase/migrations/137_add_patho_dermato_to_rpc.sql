-- ============================================================================
-- eFondaMental Platform - Add Pathologies Dermatologiques to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_patho_dermato table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 72 if Fagerstrom required, 71 otherwise (includes ECG, SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO, PATHO_CARDIO, PATHO_ENDOC, PATHO_DERMATO)
        CASE WHEN v_fagerstrom_required THEN 72 ELSE 71 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (14) - includes SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO, PATHO_CARDIO, PATHO_ENDOC, PATHO_DERMATO
