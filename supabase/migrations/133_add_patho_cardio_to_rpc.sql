-- ============================================================================
-- eFondaMental Platform - Add Pathologies Cardio-vasculaires to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_patho_cardio table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 70 if Fagerstrom required, 69 otherwise (includes ECG, SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO, PATHO_CARDIO)
        CASE WHEN v_fagerstrom_required THEN 70 ELSE 69 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (12) - includes SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO, PATHO_CARDIO
