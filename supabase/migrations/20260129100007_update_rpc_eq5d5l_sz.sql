-- ============================================================================
-- Migration: Update get_visit_detail_data RPC to include EQ5D5L_SZ
-- Description: Add EQ5D5L_SZ questionnaire status tracking for schizophrenia initial visits
-- ============================================================================

-- This migration updates the get_visit_detail_data function to include the
-- EQ5D5L_SZ questionnaire status in the v_statuses JSON object.
