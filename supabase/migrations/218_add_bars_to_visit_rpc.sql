-- ============================================================================
-- Migration: Add BARS questionnaire to get_visit_detail_data RPC
-- ============================================================================
-- Adds tracking for BARS (Brief Adherence Rating Scale) completion status
-- in the initial_evaluation visit type
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Chunk 6: mod_auto_traits part 2 + schizophrenia questionnaires (15 items) - added BARS
    v_statuses := v_statuses || jsonb_build_object(
