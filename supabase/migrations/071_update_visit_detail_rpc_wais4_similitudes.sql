-- ============================================================================
-- eFondaMental Platform - Update Visit Detail RPC for WAIS-IV Similitudes
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- WAIS-IV Similitudes questionnaire (52 total questionnaires)
...
-- Recreate function with WAIS-IV Similitudes support
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    -- Initial evaluation visit with 52 questionnaires
    ...
    -- Neuropsychological Evaluation (12: 7 WAIS + TMT + Stroop + Fluences + COBRA + CPT3)
