-- ============================================================================
-- Migration: Add SUMD questionnaire to get_visit_detail_data RPC
-- ============================================================================
-- Adds tracking for SUMD (Scale to Assess Unawareness of Mental Disorder) 
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Chunk 6: mod_auto_traits part 2 + schizophrenia questionnaires (10 items) - added SUMD
    v_statuses := v_statuses || jsonb_build_object(
