-- ============================================================================
-- eFondaMental Platform - Add Pathologies hépato-gastro-entérologiques to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_patho_hepato_gastro table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 75 if Fagerstrom required, 74 otherwise (includes PATHO_HEPATO_GASTRO)
        CASE WHEN v_fagerstrom_required THEN 75 ELSE 74 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (17) - includes PATHO_HEPATO_GASTRO
