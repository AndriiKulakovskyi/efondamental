-- Migration: Update get_visit_detail_data RPC to track schizophrenia nurse questionnaires for annual visits
-- Purpose: Add schizophrenia nurse module completion tracking for annual_evaluation visit type
-- Date: 2026-02-04

-- Drop and recreate the function with schizophrenia annual visit support
