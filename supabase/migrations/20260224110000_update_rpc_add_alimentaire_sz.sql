-- Add ALIMENTAIRE_SZ to get_visit_detail_data RPC for both initial and annual evaluation.
...
COMMENT ON FUNCTION "public"."get_visit_detail_data"("p_visit_id" "uuid") IS 'Returns complete visit details including questionnaire completion status. Updated to include ALIMENTAIRE_SZ for schizophrenia.';
