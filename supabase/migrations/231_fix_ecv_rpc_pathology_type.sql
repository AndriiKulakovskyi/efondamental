-- Fix the get_visit_detail_data RPC function to properly join with pathologies table
-- The pathology_type is on the pathologies table, not directly on patients
