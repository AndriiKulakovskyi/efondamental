-- ============================================================================
-- eFondaMental Platform - Add Pathologies allergiques et inflammatoires to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_patho_allergique table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 76 if Fagerstrom required, 75 otherwise (includes PATHO_ALLERGIQUE)
        CASE WHEN v_fagerstrom_required THEN 76 ELSE 75 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (18) - includes PATHO_ALLERGIQUE
