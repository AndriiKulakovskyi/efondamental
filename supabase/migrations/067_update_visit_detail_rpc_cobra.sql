-- ============================================================================
-- eFondaMental Platform - Update Visit Detail RPC for COBRA
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- COBRA questionnaire (50 total questionnaires)
...
-- Recreate function with COBRA support
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    -- Initial evaluation visit with 50 questionnaires
    ...
    -- Neuropsychological Evaluation (10: WAIS-4 + CVLT + Code + Digit Span + TMT + Stroop + Fluences + COBRA)
