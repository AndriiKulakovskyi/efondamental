-- Add PERINATALITE_SZ completion status to get_visit_detail_data RPC function
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Chunk 7: SUICIDE_HISTORY_SZ + ANTECEDENTS_FAMILIAUX_PSY_SZ + PERINATALITE_SZ (3) - schizophrenia-specific questionnaires
    v_statuses := v_statuses || jsonb_build_object(
