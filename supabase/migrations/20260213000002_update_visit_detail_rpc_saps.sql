...
-- Update get_visit_detail_data RPC to include SAPS and missing hetero-questionnaires for schizophrenia visits
...
COMMENT ON FUNCTION "public"."get_visit_detail_data"("p_visit_id" "uuid") IS 'Returns complete visit details including questionnaire completion status. Updated to include SAPS and missing hetero-questionnaires for schizophrenia.';
