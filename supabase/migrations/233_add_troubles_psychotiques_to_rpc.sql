-- Add TROUBLES_PSYCHOTIQUES completion status to get_visit_detail_data RPC function
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Chunk 6: SAS + PSP + ECV + TROUBLES_PSYCHOTIQUES (4) - schizophrenia questionnaires
    v_statuses := v_statuses || jsonb_build_object(
