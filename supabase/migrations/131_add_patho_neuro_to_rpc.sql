-- ============================================================================
-- eFondaMental Platform - Add Pathologies Neurologiques to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_patho_neuro table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 69 if Fagerstrom required, 68 otherwise (includes ECG, SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO)
        CASE WHEN v_fagerstrom_required THEN 69 ELSE 68 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (11) - includes SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO
