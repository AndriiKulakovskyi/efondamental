-- Update the get_visit_detail_data RPC function to include ECV completion status
-- This adds ECV tracking to the schizophrenia questionnaires chunk
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    -- Chunk 6: SAS + PSP + ECV (3) - schizophrenia questionnaires
    v_statuses := v_statuses || jsonb_build_object(
