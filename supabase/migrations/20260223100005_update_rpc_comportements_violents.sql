...
-- Add COMPORTEMENTS_VIOLENTS_SZ to the annual_evaluation branch (medical module block)
...
COMMENT ON FUNCTION "public"."get_visit_detail_data"("p_visit_id" "uuid") IS 'Returns complete visit details including questionnaire completion status. Annual visits include COMPORTEMENTS_VIOLENTS_SZ in the medical module.';
