-- ============================================================================
-- Migration: Fix get_visit_detail_data RPC - Complete questionnaire statuses
-- ============================================================================
-- Issue: The RPC was missing many questionnaire statuses that the frontend
-- expects for each visit type. This caused questionnaires to appear incomplete
-- even when they were filled out.
--
-- Fixes:
-- 1. Screening: Add MDQ_FR, BIPOLAR_ORIENTATION_FR (remove wrong MADRS, YMRS, CGI)
-- 2. Biannual follow-up: Add SUICIDE_BEHAVIOR_FOLLOWUP_FR
-- 3. Initial/Annual evaluation: Add all missing questionnaires (DSM5_PSYCHOTIC,
--    SIS, SUICIDE_HISTORY, PATHO_*, PERINATALITE, WAIS questionnaires, etc.)
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'annual_evaluation' THEN
    -- =========================================================================
    -- ANNUAL EVALUATION: 4 modules
    -- mod_nurse: 6 (TOBACCO, FAGERSTROM, PHYSICAL_PARAMS, BLOOD_PRESSURE, SLEEP_APNEA, BIOLOGICAL_ASSESSMENT) - no ECG
