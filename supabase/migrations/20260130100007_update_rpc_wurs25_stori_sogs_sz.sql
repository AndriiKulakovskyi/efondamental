-- ============================================================================
-- Migration: Update get_visit_detail_data RPC to include WURS25_SZ, STORI_SZ, SOGS_SZ
-- Description: Add completion status tracking for three new schizophrenia questionnaires:
--   - WURS-25 (Échelle de Wender Utah) - schizophrenia_wurs25
--   - STORI (Stades du Rétablissement) - schizophrenia_stori
--   - SOGS (Jeu Pathologique) - schizophrenia_sogs
-- ============================================================================
