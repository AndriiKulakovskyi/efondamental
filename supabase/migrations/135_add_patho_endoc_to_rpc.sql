-- ============================================================================
-- eFondaMental Platform - Add Pathologies Endocriniennes et Métaboliques to RPC Function
-- ============================================================================
-- This migration updates the get_visit_detail_data RPC function to include
-- the new responses_patho_endoc table
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_visit_type = 'initial_evaluation' THEN
    ...
    completion_calc AS (
      SELECT 
        -- Total is 71 if Fagerstrom required, 70 otherwise (includes ECG, SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO, PATHO_CARDIO, PATHO_ENDOC)
        CASE WHEN v_fagerstrom_required THEN 71 ELSE 70 END AS total_questionnaires,
        (
          ...
          -- MEDICAL questionnaires (13) - includes SUICIDE_HISTORY, PERINATALITE, PATHO_NEURO, PATHO_CARDIO, PATHO_ENDOC
