-- Final fix for get_visit_detail_data RPC for Schizophrenia.
-- Corrects all table names (schizophrenia_isa -> schizophrenia_isa_initial, etc.)
-- and ensures ALL questionnaires are tracked (including SANS, UKU, ALIMENTAIRE_SZ, etc.)
...
COMMENT ON FUNCTION "public"."get_visit_detail_data"("p_visit_id" "uuid") IS 'Returns complete visit details including questionnaire completion status. FIXED: schizophrenia_isa_initial, schizophrenia_suicide_history_initial, ALIMENTAIRE_SZ, SANS, UKU.';
