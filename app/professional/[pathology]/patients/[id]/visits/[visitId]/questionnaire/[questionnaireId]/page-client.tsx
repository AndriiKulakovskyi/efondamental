  ...
  const handleSubmit = async (responses: Record<string, any>) => {
    ...
    try {
      ...
      const hasScoring = [
        ...
        'WAIS4_MATRICES', 'WAIS4_SIMILITUDES', 'WAIS4_CRITERIA', 'WAIS4_LEARNING', 'CVLT', 'CVLT_SZ', 'TMT_SZ', 'WAIS4_CODE', 'WAIS_IV_CODE_SYMBOLES_IVT', 'WAIS4_DIGIT_SPAN', 'FLUENCES_VERBALES',
