        ...
        const dsm5Questionnaires: any[] = [
          {
            ...
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['DIAG_PSY_SEM_HUMEUR_ACTUELS_FR']?.completed || false,
            completedAt: questionnaireStatuses['DIAG_PSY_SEM_HUMEUR_ACTUELS_FR']?.completed_at,
          },
          {
            ...DIAG_PSY_SEM_HUMEUR_DEPUIS_VISITE_DEFINITION,
            id: DIAG_PSY_SEM_HUMEUR_DEPUIS_VISITE_DEFINITION.code,
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['DIAG_PSY_SEM_HUMEUR_DEPUIS_VISITE_FR']?.completed || false,
            completedAt: questionnaireStatuses['DIAG_PSY_SEM_HUMEUR_DEPUIS_VISITE_FR']?.completed_at,
          },
          {
            ...DIAG_PSY_SEM_PSYCHOTIQUES_DEFINITION,
            id: DIAG_PSY_SEM_PSYCHOTIQUES_DEFINITION.code,
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['DIAG_PSY_SEM_PSYCHOTIQUES_FR']?.completed || false,
            completedAt: questionnaireStatuses['DIAG_PSY_SEM_PSYCHOTIQUES_FR']?.completed_at,
          },
        ];
        ...
        const soinSuiviQuestionnaires = [
          {
            ...
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['SUIVI_RECOMMANDATIONS_FR']?.completed || false,
            completedAt: questionnaireStatuses['SUIVI_RECOMMANDATIONS_FR']?.completed_at,
          },
          {
            ...RECOURS_AUX_SOINS_DEFINITION,
            id: RECOURS_AUX_SOINS_DEFINITION.code,
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['RECOURS_AUX_SOINS_FR']?.completed || false,
            completedAt: questionnaireStatuses['RECOURS_AUX_SOINS_FR']?.completed_at,
          },
          {
            ...TRAITEMENT_NON_PHARMACOLOGIQUE_DEFINITION,
            id: TRAITEMENT_NON_PHARMACOLOGIQUE_DEFINITION.code,
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['TRAITEMENT_NON_PHARMACOLOGIQUE_FR']?.completed || false,
            completedAt: questionnaireStatuses['TRAITEMENT_NON_PHARMACOLOGIQUE_FR']?.completed_at,
          },
          {
            ...ARRETS_DE_TRAVAIL_DEFINITION,
            id: ARRETS_DE_TRAVAIL_DEFINITION.code,
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['ARRETS_DE_TRAVAIL_FR']?.completed || false,
            completedAt: questionnaireStatuses['ARRETS_DE_TRAVAIL_FR']?.completed_at,
          },
          {
            ...SOMATIQUE_CONTRACEPTIF_DEFINITION,
            id: SOMATIQUE_CONTRACEPTIF_DEFINITION.code,
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['SOMATIQUE_ET_CONTRACEPTIF_FR']?.completed || false,
            completedAt: questionnaireStatuses['SOMATIQUE_ET_CONTRACEPTIF_FR']?.completed_at,
          },
          {
            ...STATUT_PROFESSIONNEL_DEFINITION,
            id: STATUT_PROFESSIONNEL_DEFINITION.code,
            target_role: 'healthcare_professional',
            completed: questionnaireStatuses['STATUT_PROFESSIONNEL_FR']?.completed || false,
            completedAt: questionnaireStatuses['STATUT_PROFESSIONNEL_FR']?.completed_at,
          }
        ];
