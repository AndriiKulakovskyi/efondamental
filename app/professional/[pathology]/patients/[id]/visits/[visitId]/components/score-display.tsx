        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">
                                  ...
                                  : code === "AIM"
                                    ...
                                    : code === "AQ12"
                                      ? data.total_score !== undefined
                                        ...
                                        : "-"
                                      : code === "ALDA"
                                        ? data.alda_score !== undefined
                                          ? data.alda_score
                                          : "-"
                                        : code === "CGI" || code === "CGI_SZ"
                                          ? data.therapeutic_index !==
                                              undefined &&
                                          ...
                                          : code === "MADRS"
                                            ...
                                            : code === "YMRS" ||
                                              ...
                                              ? data.total_score !== undefined
                                                ...
                                                : "-"
                                              : code === "EGF_SZ"
                                                ? data.egf_score !== undefined
                                                  ? data.egf_score
                                                  : "-"
                                                : code === "WAIS4_MATRICES"
                                                  ? data.standardized_score !==
                                                    undefined
                                                    ? data.standardized_score
                                                    : "-"
                                                  : code === "WAIS4_MATRICES_SZ"
                                                                                                      ...
                                                                                                      : code ===
                                                                                                        ...
                                                                                                        : code ===
                                                                                                          ...
                                                                                                          : code ===
                                                                                                            ...
                                                                                                            ? data.total_score !==
                                                                                                              undefined
                                                                                                              ? `${parseFloat(data.total_score).toFixed(1)}/12`
                                                                                                              : "-"
                                                                                                            : code ===
                                                                                                                "YBOCS_SZ"
                                                                                                              ? data.total_score !==
                                                                                                              ...
                                                                                                              : code ===
                                                                                                                ...
                                                                                                                : code ===
                                                                                                                  ...
                                                                                                                  : code ===
                                                                                                                      "PRESENTEISME_SZ"
                                                                                                                    ? data.productivite_pct !==
                                                                                                                      undefined
                                                                                                                      ? `${data.productivite_pct.toFixed(0)}%`
                                                                                                                      : "-"
                                                                                                                    : code ===
                                                                                                                        "IPAQ_SZ"
                                                                                                                      ? data.total_met_minutes !==
                                                                                                                        undefined
                                                                                                                        ? `${Math.round(data.total_met_minutes)} MET-min/sem`
                                                                                                                        : "-"
                                                                                                                      : code ===
                                                                                                                          "MATHYS"
                                                                                                                        ? data.total_score !==
                                                                                                                          undefined
                                                                                                                          ? `${parseFloat(data.total_score).toFixed(1)}/200`
                                                                                                                          : "-"
                                                                                                                        : code ===
                                                                                                                            "QIDS_SR16"
                                                                                                                          ? data.total_score !==
              ...
              {code === "WAIS4_CODE" && "/19"}
              {code === "WAIS_IV_CODE_SYMBOLES_IVT" &&
                (data.wais_ivt !== undefined && data.wais_ivt !== null
                  ? "/150"
                  : "/19")}
              {code === "PANSS" && "/210"}
              {code === "CDSS" && "/27"}
