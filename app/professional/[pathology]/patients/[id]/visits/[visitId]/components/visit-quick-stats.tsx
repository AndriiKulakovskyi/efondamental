  ...
  return (
    <div className="grid grid-cols-4 gap-6 mb-10">
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between relative overflow-hidden">
        ...
        <div>
          <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Global Progress</p>
      ...
      {/* Forms Done Card */}
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
        <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Forms Done</p>
        <div className="flex items-baseline gap-2 mt-1">
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="flex items-baseline gap-2 mt-1">
          ...
          <span className="text-sm font-medium text-slate-400">forms</span>
        </div>
      </div>
    </div>
  );
